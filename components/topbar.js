...
export function Topbar() {
  ...
  return (
    <div className="top-0 sticky z-20">
      <div className=" top-0 left-0 right-0 backdrop-blur-md bg-slate-900/60 hover:bg-slate-900/80 transition-all duration-500 ease-in-out">
        ...
        <div
          className={`relative p-1 right-0 text-yellow-400 flex-col backdrop-blur-md float-right bg-slate-900/60 hover:bg-slate-900/80 peer-hover:bg-slate-900/80 gap-4 py-4 transition-all duration-500 ease-in-out ${
            menuVisible ? "flex opacity-100" : "hidden opacity-0"
          }`}
        >
          {pages}
        </div>

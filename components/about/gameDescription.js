export function GameDescription() {
  return (
    <>
      <h1 className="text-5xl text-yellow-400 font-semibold py-3">ABOUT</h1>
      <div id="contents">
        ...
        <p className="py-4">
          ...
          game is very <em>upbeat</em> and <em>optimistic</em>, taking place in
          a totally hypothetical and fictional dystopian world where
